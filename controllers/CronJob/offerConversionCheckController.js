    ...
    for (let i = 0; i < offerData.length; i++) {
      ...
      if (advName.email_preferences == true) {
        ...
        const msgAdvertiser = {
          ...
          bcc: bcc_mail,
          subject: 'Applabs Alert - Your campaign ' + ucfirst(offDt.offer_name) + ' is Paused',
      ...
      const msgAdmin = {
        ...
        //bcc: bcc_mail,
        subject: 'Applabs Alert - Campaign ' + ucfirst(offDt.offer_name) + '[' + offDt.trackier_camp_id + '] Paused',
