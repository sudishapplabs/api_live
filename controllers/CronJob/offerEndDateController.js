      ...
      if (offDt.schedule_end_date && offDt.schedule_end_date !== null) {
        ...
        if (offDt.schedule_end_date == todaywithSlashes) {
          ...
          const notificationData = {
            ...
            message_adv: "Today is the end date for your campaign <span class='text_primary'> " + offDt.offer_name + "[" + offDt.trackier_camp_id + "]</span> and it will be paused. For an uninterrupted delivery please sign in to your account and review the campaign.",
